// ============================================================
// settings.js - Configuración de cuenta
// ============================================================
...
function saveSettingsChanges() {
    ...
    if (newPass || confirmPass || currentPass) {
        ...
        var result = updateUserProfile(currentUser, data);
        if (result.success) {
            ...
            messageEl.innerHTML = '<span style="color:#f87171;">❌ ' + result.error + '</span>';
        }
    } else {
...
function openDeleteConfirmation() {
    ...
    document.getElementById('deleteConfirmYes').addEventListener('click', function() {
        ...
        var result = deleteUserAccount(currentUser, password);
        if (result.success) {
            errorEl.textContent = '';
            overlay.innerHTML = `
